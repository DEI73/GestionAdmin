...
<div class="ga-public-container ga-portal-empleado">
    <div class="ga-container">
        ...
        <div class="ga-coming-soon">
            ...
            <p><?php esc_html_e('Esta sección estará disponible próximamente con:', 'gestionadmin-wolk'); ?></p>

            <div class="ga-features-list">
                <div class="ga-feature-item">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <?php esc_html_e('Lista de tareas pendientes y completadas', 'gestionadmin-wolk'); ?>
                </div>
                <div class="ga-feature-item">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <?php esc_html_e('Filtros por estado, prioridad y proyecto', 'gestionadmin-wolk'); ?>
                </div>
                <div class="ga-feature-item">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <?php esc_html_e('Timer integrado para registro de horas', 'gestionadmin-wolk'); ?>
                </div>
                <div class="ga-feature-item">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <?php esc_html_e('Sistema de subtareas y dependencias', 'gestionadmin-wolk'); ?>
                </div>
            </div>
