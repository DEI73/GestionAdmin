...
<div class="ga-public-container ga-portal-empleado">
    <div class="ga-container">
        <div class="ga-portal-header">
            ...
            <p><?php esc_html_e('Gestiona tu información personal', 'gestionadmin-wolk'); ?></p>
        </div>
        ...
        <div class="ga-coming-soon">
            ...
            <p><?php esc_html_e('La gestión de perfil estará disponible próximamente con:', 'gestionadmin-wolk'); ?></p>

            <div class="ga-features-list">
                <div class="ga-feature-item">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <?php esc_html_e('Información personal y de contacto', 'gestionadmin-wolk'); ?>
                </div>
                <div class="ga-feature-item">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <?php esc_html_e('Datos bancarios para pagos', 'gestionadmin-wolk'); ?>
                </div>
                <div class="ga-feature-item">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <?php esc_html_e('Documentos y certificaciones', 'gestionadmin-wolk'); ?>
                </div>
                <div class="ga-feature-item">
                    <span class="dashicons dashicons-yes-alt"></span>
                ...
                <div class="ga-feature-item">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <?php esc_html_e('Cambio de contraseña', 'gestionadmin-wolk'); ?>
                </div>
            </div>
